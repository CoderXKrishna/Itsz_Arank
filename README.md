...
[![Publish Docker image](https://github.com/CoderXKrishna/Itsz_Arank/actions/workflows/publish.yaml/badge.svg)](https://github.com/CoderXKrishna/Itsz_Arank/actions/workflows/publish.yaml)
...
### Arank
![Arank](https://telegra.ph/file/f3fb258bbedf3d2627f28.jpg)
...
- [x] Track token usage per user - by [CoderXKrishna(https://github.com/CoderXKrishna)
- [x] Get personal token usage statistics via the `/stats` command - by [CoderXKrishna](https://github.com/CoderXKrishna)
- [x] User budgets and guest budgets - by [CoderXKrishna](https://github.com/CoderXKrishna)
- [x] Stream support
- [x] GPT-4 support
...
- [x] Improved inline queries support for group and private chats - by [CoderXKrishna](https://github.com/CoderXKrishna)
...
- [x] Support unofficial OpenAI-compatible APIs - by [CoderXKrishna](https://github.com/CoderXKrishna)
- [x] (NEW!) Support GPT-4 Turbo and DALL·E 3 [announced on November 6, 2023](https://openai.com/blog/new-models-and-developer-products-announced-at-devday) - by [CoderXKrishna](https://github.com/CoderXKrishna)
- [x] (NEW!) Text-to-speech support [announced on November 6, 2023](https://platform.openai.com/docs/guides/text-to-speech) - by [CoderXKrishna](https://github.com/CoderXKrishna)
- [x] (NEW!) Vision support [announced on November 6, 2023](https://platform.openai.com/docs/guides/vision) - by [CoderXKrishna(https://github.com/CoderXKrishna)

## Additional features - help needed!
If you'd like to help, check out the [issues](https://github.com/CoderXKrishna/Itsz_Arank/issues) section and contribute!  
...
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| `BUDGET_PERIOD`       | Determines the time frame all budgets are applied to. Available periods: `daily` *(resets budget every day)*, `monthly` *(resets budgets on the first of each month)*, `all-time` *(never resets budget)*. See the  for more information | `*`                |
| `GUEST_BUDGET`        | $-amount as usage limit for all guest users. Guest users are users in group chats that are not in the `ALLOWED_TELEGRAM_USER_IDS` list. Value is ignored if no usage limits are set in user budgets (`USER_BUDGETS`=`*`). See the [Budget Manual](https://github.com/CoderXKrishna/Itsz_Arank/discussions/184) for more information                                                   | `100.0`            |
...
| `BOT_LANGUAGE`                      | Language of general bot messages. Currently available: `en`, `de`, `ru`, `tr`, `it`, `fi`, `es`, `id`, `nl`, `zh-cn`, `zh-tw`, `vi`, `fa`, `pt-br`, `uk`, `ms`, `uz`, `ar`.  [Contribute with additional translations](https://github.com/CoderXKrishna/Itsz_Arank/discussions/219) | `en`                               |
...
```shell
git clone https://github.com/CoderXKrishna/Itsz_Arank.git
